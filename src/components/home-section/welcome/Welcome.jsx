...
const Welcome = (props) => {
  useEffect(() => {
    ...
    const autoImageSlide = () => {
      if (nextImg >= welcomeImgs.length) {
        nextImg = 0;
      }
      if (currentImg >= welcomeImgs.length) {
        currentImg = 0;
      }

      welcomeImgs[nextImg].classList.add('active');
      welcomeImgs[currentImg].classList.remove('active');
      nextImg++;
      currentImg++;
    };
  ...
  return (
    ...
    >
      <div className="welcome__info relative">
        <div className="welcome__info__con tent">
          <div className="title">
